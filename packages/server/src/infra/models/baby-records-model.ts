...
export class BabyRecordModel {
    ...
    @Column({ type: "varchar", name: "observations", length: 300, nullable: true })
    ...
    @Column({ type: "int", name: "weight", nullable: true })
    public weight!: number;

    @Column({ type: "int", name: "breastfeeding_amount", nullable: true })
    public breastfeedingAmount!: number;

    @Column({ type: "varchar", name: "sleep_quality", length: 30, nullable: true })
    public sleepQuality!: string;

    @Column({ type: "varchar", name: "breastfeeding_type", length: 30, nullable: true })
    public breastfeedingType!: string;

    @Column({ type: "timestamp", name: "init_at" })
    public init!: Date;
